...
from .utils import DistriConfig, PatchParallelismCommManager, PCPPCommManager
...
class DistriSDXLPipeline:
    ...
    def prepare(self, **kwargs):
        ...
        if distri_config.n_device_per_batch > 1:
            comm_manager = PCPPCommManager(distri_config)
            ...
            # do one forward pass to create the buffer
            # this will assign each module to an self.idx.
