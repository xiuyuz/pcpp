...
from ..utils import PatchParallelismCommManager, DistriConfig, PCPPCommManager
...
class BaseModel(ModelMixin, ConfigMixin):
    ...
    def set_comm_manager(self, comm_manager: PCPPCommManager):
    ...
    def synchronize(self):
        ...
        if self.comm_manager is not None and self.comm_manager.requests is not None:
